...
//     usedX[NBTRAP + NBPLAYER] = pirateX;
//     usedY[NBTRAP + NBPLAYER] = pirateY;

//     usedX[TOTAL_ENTITY] = treasureX;
//     usedY[TOTAL_ENTITY] = treasureY;

//     srand(time(NULL));

//     generateUniqueCoordinates(&playerX, &playerY, usedX, usedY, TOTAL_ENTITY);
//     generateUniqueCoordinates(&treasureX, &treasureY, usedX, usedY, TOTAL_ENTITY);
//     generateUniqueCoordinates(&pirateX, &pirateY, usedX, usedY, TOTAL_ENTITY);
...
extern void gameInitialisation(Game* this) {
    ...
    int usedX[TOTAL_ENTITY + NBTRAP];
    int usedY[TOTAL_ENTITY + NBTRAP];
    int usedCount = 0;
